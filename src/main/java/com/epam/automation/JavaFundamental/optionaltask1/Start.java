    ...
    public static void main(String[] args)
    {
        while(true)
        {
            ...
            System.out.println("First number with less differences is: " +
                    numbers.getNumberWithMinimumVariousNumbers(initialArr) +
                    " Task №4");
            ...
            System.out.println("Number with only odd number is: " + numbers.getNumbersWithOnlyOddValues(initialArr) +
                    ...
                    numbers.getAmountHalfOddAndHalfEvenValuesInNumber(initialArr) +
                    " Task №5");

            System.out.println("First increase number with strict orders is: " +
                    numbers.getNumberWithStrictIncreaseOrder(initialArr) +
                    " Task №6");

            System.out.println("Firs max difference number is: " +
                    numbers.getMaxDifferenceNumber(initialArr) +
                    " Task №7");
